                                                ...
                                                <tr key={eleve.id} className="hover:bg-slate-50/80 transition group">
                                                    ...
                                                    <td className="px-4 py-3">
                                                        <div className="flex items-center">
                                                            {eleve.photo ? (
                                                                <img src={eleve.photo.startsWith('http') ? eleve.photo : `https://schoolndtg.onrender.com/storage/${eleve.photo}`} alt="" className="w-8 h-8 rounded-full object-cover mr-3" />
                                                            ) : (

                                    ...
                                    <tr key={prof.id} className="hover:bg-slate-50/80 transition group">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center">
                                                {prof.photo ? (
                                                    <img src={prof.photo.startsWith('http') ? prof.photo : `https://schoolndtg.onrender.com/storage/professeurs/${prof.photo}`} alt="" className="w-10 h-10 rounded-full object-cover mr-4" />
                                                ) : (
